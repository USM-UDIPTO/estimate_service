package com.dxc.eproc.estimate.aop.logging;
...
public class LoggingAspect {
	...
	@Pointcut("within(@org.springframework.stereotype.Repository *)"
			...
			+ " || within(@org.springframework.controller.annotation.RestController *)")
	 ...
	 */
	@Pointcut("within(com.dxc.eproc.estimate.repository..*)" + " || within(com.dxc.eproc.estimate.service..*)"
			+ " || within(com.dxc.eproc.estimate.controller..*)")
